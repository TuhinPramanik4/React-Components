...
function App() {
  ...
  return (
    <div ref={scope} className="w-full h-screen flex justify-center items-center bg-gray-200">
      <button
        onClick={onButtonClick}
        className="relative z-5 rounded-full border-2 border-blue-600 px-6 py-2 text-2xl text-blue-600 transition-colors hover:bg-blue-100"
      >
